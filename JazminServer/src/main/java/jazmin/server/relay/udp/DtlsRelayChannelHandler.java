 ...
 * 26 Apr, 2015
 */
public class DtlsRelayChannelHandler  extends SimpleChannelInboundHandler<DatagramPacket>{
	private static Logger logger=LoggerFactory.getLogger(RelayChannel.class);
	//
	DtlsRelayChannel relayChannel;
	public DtlsRelayChannelHandler(DtlsRelayChannel relayChannel) {
