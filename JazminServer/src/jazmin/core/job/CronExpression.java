...
public class CronExpression implements Serializable, Cloneable {
	...
	protected static final Map<String,Integer>monthMap 
								= new HashMap<String,Integer>(20);
	protected static final Map<String,Integer> dayMap 
								= new HashMap<String,Integer>(60);
	static {
	...
	protected void buildExpression(String expression) throws ParseException {
		...
		try {
			...
			throw new ParseException("Illegal cron expression format (" + e.getMessage() + ")", 0);
		}
	}
	 ...
	 * @param set java.util.Set<Integer>
	 * @return String
	 */
	...
	/**
	 * Method getExpressionSetSummary.
	 * @param list java.util.ArrayList<Integer>
	 * @return String
	 */
