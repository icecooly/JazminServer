...
public class LuceneSearchDriver extends Driver{
	...
	//
	public List<SearchDocument> searchDocuments(String key[],String query,int number, int totalHitsThreshold) 
			throws SearchException{
		try{
			initReader();
			IndexSearcher searcher = new IndexSearcher(reader);
			TopScoreDocCollector collector = TopScoreDocCollector.create(number, totalHitsThreshold);
